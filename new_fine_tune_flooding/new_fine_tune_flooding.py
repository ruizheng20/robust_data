...
def finetune(args):
    ...
    try:
        ...
        for epoch in range(args.epochs):
            ...
            global_step = train_one_epoch_new(args, avg_loss, device, epoch, model, optimizer, scheduler, train_loader, global_step, save_steps, tokenizer,result_data_indices,beta=args.beta,b=args.b)
...
def train_one_epoch_new(args, avg_loss, device, epoch, model, optimizer, scheduler, train_loader, global_step, save_steps, tokenizer,result_data_indices,beta=1,b=0.1):
